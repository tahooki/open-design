...
> Kakao-inspired messenger and platform UI: warm yellow identity, chat-first patterns, friendly social surfaces, and clean Korean digital-product ergonomics.

Source adaptation: Design System Inspiration of Kakao (카카오).
...
Adapted from `oh-my-design-cli@1.2.0` / `web/references/kakao/DESIGN.md` (MIT). The referenced brand names, logos, and official design materials belong to their respective companies. This DESIGN.md is an aesthetic inspiration for AI-assisted UI generation, not official brand documentation.
